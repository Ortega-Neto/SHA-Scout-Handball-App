...
import br.com.lconeto.library.data.database.shoot.Shoot
import br.com.lconeto.library.data.database.shoot.ShootDao
import br.com.lconeto.library.data.database.team.Team
import br.com.lconeto.library.data.database.team.TeamDao

@Database(entities = [Game::class, Team::class, Player::class, Shoot::class], version = 1)
